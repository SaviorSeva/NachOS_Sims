...
public:
  ...
  // to get!)
  bool NoBlockGet(PacketHeader *pktHdr, MailHeader *mailHdr, char *data);
private:
...
public:
  ...
  bool NoBlockReceive(int box, PacketHeader *pktHdr,
                         MailHeader *mailHdr, char *data);
  // Retrieve a message from "box".  Return false
  // if there are no message in the box.
